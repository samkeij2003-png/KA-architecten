...
export const projects: Project[] = [
  ...
  {
    slug: 'woningbouwplan-forum-reeshof-tilburg',
    title: 'Woningbouwplan Forum Reeshof',
    location: 'Tilburg',
    province: 'Noord-Brabant',
    year: '2013',
    type: 'Woningbouw',
    status: 'Opgeleverd',
    cover: '/images/forum-1.jpg',
    images: ['/images/forum-1.jpg', '/images/forum-3.jpg', '/images/forum-2.jpg'],
    architect: 'Peter Keijsers',
    aannemer: '—',
    fotograaf: '—',
    constructeur: '—',
    intro: 'Een woningbouwproject in de Tilburgse Reeshof: een blok herkenbare gezinswoningen rond een gedeeld plein.',
    body: [
      'De stedenbouwkundige opzet zet in op een duidelijke voorkant aan het plein en een beschutte achterzijde met privé-tuinen. Variatie in kapvorm en gevelkleur geeft het ensemble karakter.',
      'Een terughoudend kleurpalet verbindt de verschillende blokken visueel.',
    ],
  },
];
